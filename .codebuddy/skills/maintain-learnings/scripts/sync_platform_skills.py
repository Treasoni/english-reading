...
def normalized_text(text: str) -> str:
    replacements = {
        ".codebuddy/skills": "{SKILLS_DIR}",
        ".claude/skills": "{SKILLS_DIR}",
        ".codebuddy/hooks/read-learnings.sh": "{HOOK_READ_LEARNINGS}",
        ".claude/hooks/read-learnings.sh": "{HOOK_READ_LEARNINGS}",
        ".codebuddy/hooks": "{HOOKS_DIR}",
        ".claude/hooks": "{HOOKS_DIR}",
        ".codebuddy/settings.json": "{PLATFORM_SETTINGS}",
        ".claude/settings.json": "{PLATFORM_SETTINGS}",
        ".claude/settings.local.json": "{PLATFORM_SETTINGS_LOCAL}",
        "CodeBuddy hook": "{PLATFORM_HOOK}",
        "Claude Code hook": "{PLATFORM_HOOK}",
        "codebuddy-hook": "{PLATFORM_HOOK_CLUSTER}",
        "claude-hook": "{PLATFORM_HOOK_CLUSTER}",
        "`CODEBUDDY.md`": "`{PROJECT_RULES}`",
        "`CLAUDE.md` / `CODEBUDDY.md`": "`{PROJECT_RULES}`",
...
def transform_text(text: str, source: str, target: str) -> str:
    ...
    pairs = [
        ...
        (".codebuddy/hooks/read-learnings.sh", ".claude/hooks/read-learnings.sh"),
        (".claude/hooks/read-learnings.sh", ".codebuddy/hooks/read-learnings.sh"),
        (".codebuddy/settings.json", ".claude/settings.json"),
        (".claude/settings.json", ".codebuddy/settings.json"),
        ("CodeBuddy hook", "Claude Code hook"),
        ("Claude Code hook", "CodeBuddy hook"),
        ("codebuddy-hook", "claude-hook"),
        ("claude-hook", "codebuddy-hook"),
    ]
    transformed = text
