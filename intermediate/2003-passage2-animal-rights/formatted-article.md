---
title: "2003-Passage 2: Animal Rights vs Biomedical Research"
type: article
topic: "2003-passage2-animal-rights"
tags:
  - english-reading
  - formatted-article
  - 2003
...
updated: 2026-06-18
sources:
  - "英语阅读资料/2003阅读/passage_2.md"
---

# 2003-Passage 2: Animal Rights vs Biomedical Research
...
> **主干提取**：
>
> - **S (主语)**：All (that is needed for the triumph of a misguided cause)
> - **V (谓语)**：is
> - **C (表语)**：that good people do nothing（表语从句）
>
> **简化主干**：All is that good people do nothing.
>
> **修饰成分**：
>
> | 类型 | 引导词/内容 | 修饰对象 |
> |------|------------|----------|
> | 不定式 | To paraphrase | 整句的目的状语 |
> | 同位语 | 18th-century statesman | Edmund Burke（解释身份）|
> | 定语从句 | that is needed for the triumph of a misguided cause | All（主语 all 的定语）|
> | 介词短语 | for the triumph of a misguided cause | is needed（说明需要的对象）|
> | 表语从句 | that good people do nothing | is（作表语）|
>
> **结构图解**：
> ```
> 主句: All + is + that good people do nothing
>   ├── 定从: (that is needed for the triumph of a misguided cause) → 修饰 All
>   │     └── 介短: (for the triumph of a misguided cause) → 修饰 is needed
>   └── 表从: (that good people do nothing) → 作表语
>
> 外层结构:
>   ├── 不定式: (To paraphrase) → 目的状语
>   └── 同位语: (18th-century statesman) → 解释 Edmund Burke
> ```
>
> **参考译文**：借用18世纪政治家埃德蒙·伯克的话："要使一项被误导的事业得逞，唯一需要的就是好人无所作为。"
>
> **考点提示**：
>
> 1. **all that... 结构辨析**：注意 "all that is needed" 中 that 引导的是**定语从句**（修饰 all），而非名词性从句。当 all/only/anything/everything 等不定代词作先行词时，定语从句通常用 that 引导——这是考研阅读高频考点。
> 2. **多重从句嵌套**：本句包含定语从句（修饰主语）+ 表语从句（作表语）的复合结构，且介词短语嵌入定语从句中形成三层嵌套。
> 3. **不定式作目的状语**：句首 To paraphrase 译为"借用…的话""改述…"，引导整个直接引语的目的。
