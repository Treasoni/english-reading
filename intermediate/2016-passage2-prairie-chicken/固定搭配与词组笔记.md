...
> **③ compensate sb. for sth.（补偿某人）vs compensate for sth.（弥补某缺陷）**：本篇是**前者**（基金补偿土地所有者）；第 28 题 A 项 `agree to pay a sum for compensation` 把"**补偿他人**"偷换成"**支付补偿金**"，**实际原文缴的是"替换栖息地的钱"**。
...
> - **第 28 题（何种情况下非故意损害者不被起诉）** → 第 3 段 `it would not prosecute … **as long as they had signed a range-wide management plan to restore prairie chicken habitat**`；**正确答案是"签署恢复栖息地的管理计划"**。四个选项**全部是把第三段的机制换主体/换方向**：**A 项**把"缴款补栖息地"说成"支付补偿金"；**B 项**把"2 英亩补偿"说成"设立同等大小的栖息地"（`set up` 偷换 `set aside`，`equally big` 偷换 `2 new acres`）；**C 项**把"赋予 WAFWA 监测职责"说成"企业支持 WAFWA 监测"；**D 项**把"向基金缴款"说成"为 USFWS 筹钱"。
...
> ② **机制换主体陷阱**：第 28 题四个选项**全部**把第三段的机制**换了主体或方向**——"缴款进基金"变"为 USFWS 筹钱"、"2 英亩补偿"变"同等大小"、"赋予 WAFWA 监测"变"企业支持 WAFWA 监测"——**对策：把第三段的"谁做什么"逐项写成"主体 + 动作 + 对象"三列，再与选项一一对照，凡主体或方向不符即排除。**
