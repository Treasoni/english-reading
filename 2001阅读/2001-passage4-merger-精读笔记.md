...
# Mergers and Acquisitions 精读笔记

## 背景

本文选自 **2001年考研英语阅读 Passage 4**，主题为**企业并购（Mergers and Acquisitions）**。文章探讨了全球并购浪潮的驱动力、对竞争的影响，以及监管层面的担忧。

**为什么选择这篇文章：**
- 涉及经济、法律、国际关系等多领域话题
- 包含丰富的形式主语结构（it is hard to imagine that...）和并列谓语
- 体现考研阅读典型的"先扬后抑"论证结构

**难度说明：** 中等偏难，长难句较多，需要重点分析从句嵌套和并列结构。
...
世界正在经历有史以来规模最大的**并购**浪潮。这一进程从异常活跃的美国席卷到欧洲，并以无可匹敌的力量触及新兴国家。这些国家中的许多人正注视着这一进程并担忧："企业集中的浪潮会不会变成一股不可控的反竞争力量？"

> [!note] 翻译要点
> - **mergers and acquisitions**：并购，常缩写为 M&A，是本文的核心术语
> - **hyperactive**：这里形容美国经济异常活跃，暗示并购活动特别频繁
> - **anti-competitive force**：反竞争力量，指可能抑制市场竞争的垄断行为

---

There's no question that the big are getting bigger and more powerful. **Multinational corporations** accounted for less than 20% of international trade in 1982. Today the figure is more than 25% and growing rapidly. International affiliates account for a fast-growing segment of production in economies that open up and welcome foreign investment. In Argentina, for instance, after the reforms of the early 1990s, multinationals went from 43% to almost 70% of the industrial production of the 200 largest firms. This phenomenon has created serious concerns over the role of smaller economic firms, of national businessmen and over the ultimate stability of the world economy.

毫无疑问，大企业正变得更大、更强。1982年，**跨国公司**仅占国际贸易的不到20%。如今这一数字已超过25%，并且还在快速增长。国际附属公司在那些开放并欢迎外国投资的经济体中，占据了生产中快速增长的份额。以阿根廷为例，在20世纪90年代初的改革之后，跨国公司在200家最大企业的工业产出中所占比例从43%上升到近70%。这一现象引发了人们对小型经济企业、民族商人角色的严重担忧，以及对世界经济最终稳定性的忧虑。

> [!note] 翻译要点
> - **International affiliates**：国际附属公司，指跨国公司在海外设立的子公司或分支机构
> - **ultimate stability**：最终稳定性，强调对全球经济长期安全的深层担忧

---

I believe that the most important forces behind the massive M&A wave are the same that underlie the **globalization** process: falling transportation and communication costs, lower trade and investment barriers and enlarged markets that require enlarged operations capable of meeting customer's demands. All these are beneficial, not detrimental, to consumers. As productivity grows, the world's wealth increases.

我认为，推动这股大规模并购浪潮的最重要力量与推动**全球化**进程的力量相同：运输和通信成本的下降、贸易和投资壁垒的降低，以及需要扩大运营规模以满足客户需求的扩大市场。所有这些对消费者都是有益的而非有害的。随着生产力的增长，世界财富也在增加。

> [!note] 翻译要点
> - **underlie**：构成……的基础，此处指并购浪潮和全球化背后有相同的驱动力
> - **detrimental**：有害的，与 beneficial 形成对比，强调作者对并购的正面评价

---

Examples of benefits or costs of the current concentration wave are scanty. Yet it is hard to imagine that the merger of a few oil firms today could re-create the same threats to competition that were feared nearly a century ago in the U.S., when the **Standard Oil Trust** was broken up. The mergers of telecom companies, such as **WorldCom**, hardly seem to bring higher prices for consumers or a reduction in the pace of technical progress. On the contrary, the price of communications is falling rapidly. In cars, too, concentration is increasing—witness **Daimler and Chrysler**, **Renault and Nissan**—but it does not appear that consumers are being hurt.

当前集中化浪潮的利弊实例还很稀少。然而，很难想象今天几家石油公司的合并会重新制造出近一个世纪前美国**标准石油托拉斯**被拆分时所担忧的那种对竞争的威胁。电信公司的合并，如**世通公司**，似乎不会给消费者带来更高的价格或减缓技术进步的步伐。相反，通信价格正在快速下降。在汽车行业，集中度也在增加——见证**戴姆勒与克莱斯勒**、**雷诺与日产**的合并——但消费者似乎并未受到损害。

> [!note] 翻译要点
> - **Standard Oil Trust**：标准石油托拉斯，1911年因垄断被美国最高法院强制拆分，是反垄断史上的标志性事件
> - **WorldCom**：世通公司，美国电信巨头，2002年因财务丑闻破产，是当时最大的企业破产案之一
> - **witness**：此处用作动词，意为"见证"，用于举例说明

---

Yet the fact remains that the merger movement must be watched. A few weeks ago, **Alan Greenspan** warned against the megamergers in the banking industry. Who is going to supervise, regulate and operate as lender of last resort with the gigantic banks that are being created? Won't multinationals shift production from one place to another when a nation gets too strict about infringements to fair competition? And should one country take upon itself the role of "defending competition" on issues that affect many other nations, as in the U.S. vs. Microsoft case?

然而，事实仍然是，并购运动必须受到监督。几周前，**艾伦·格林斯潘**警告了银行业中的超大规模合并。谁来监督、监管并作为最后贷款人运作那些正在创建的巨型银行？当一个国家对公平竞争的侵权行为过于严格时，跨国公司会不会将生产从一个地方转移到另一个地方？一个国家是否应该在影响许多其他国家的问题上承担"捍卫竞争"的角色，就像美国诉微软案那样？

> [!note] 翻译要点
> - **lender of last resort**：最后贷款人，金融术语，指在金融机构面临倒闭风险时提供紧急贷款的机构（通常为中央银行）
> - **megamergers**：超大规模合并，前缀 mega- 强调规模之大
> - **infringements to fair competition**：对公平竞争的侵权/侵犯
> - **U.S. vs. Microsoft case**：美国政府诉微软反垄断案（1998-2001），是当时最受关注的反垄断案件之一
...
> [!note] 提示
> 使用 `/analyze-sentence` 添加长难句分析内容，或在文章原文中已有内联分析 callout。
...
| 结构 | 用法 | 例句 |
|------|------|------|
| military / economic might | 军事/经济实力 | The country's military might is unmatched. |
| Right is might | 正义即力量/公理即强权 | 常用于议论文写作 |
| with all one's might | 用尽全力/竭尽全力 | He pushed the heavy door with all his might. |
...
| 结构 | 用法 | 例句 |
|------|------|------|
| a mighty river | 波涛汹涌的河流 | The mighty river carved through the canyon. |
| a mighty army | 强大的军队 | A mighty army marched toward the border. |
...
| 结构 | 用法 | 例句 |
|------|------|------|
| might have done | 过去本可以做但没做，带遗憾/责备 | You might have told me the truth!（你本该告诉我真相的！） |
...
| 结构 | 用法 | 例句 |
|------|------|------|
| might as well do sth. | 在别无选择时，不妨做某事 | Since it's raining, we might as well stay at home. |

> [!tip] 语义辨析
> might as well 不是虚拟语气，而是固定搭配，表示"不妨、倒不如"。

**跨节联动：** 与 `It seems/appears that` 结构结合时，可表达推测性建议，如：It seems we might as well wait.（看来我们不妨等等。）
...
| 结构 | 用法 | 例句 |
|------|------|------|
| Shall I/we do...? | 征求对方意见或指示 | Shall I open the window?（需要我把窗户打开吗？） |
| What shall we do...? | 询问建议 | What shall we do this weekend?（我们这周末干点啥好呢？） |
...
| 结构 | 用法 | 例句 |
|------|------|------|
| Am I going to do...? | 确认自己的计划 | Am I going to class tomorrow?（我明天有课要上吗？） |
| Do I have...? | 更地道的询问日程方式 | Do I have class tomorrow?（我明天有课吗？） |
...
| 结构 | 用法 | 例句 |
|------|------|------|
| Will I/we do...? | 反问、感叹、内心独白 | Will I ever pass this exam?（我到底还能不能通过这门考试了？） |
...
| 结构 | 用法 | 例句 |
|------|------|------|
| ... , yet ... | 连接两个完整句子，表示转折 | It's a small house, yet it feels spacious.（房子虽小，然而显得很宽敞。） |
| Yet + 句子 | 句首表示"然而" | Yet the problem is not as simple as it seems.（然而，问题并不像看起来那么简单。） |
...
| 结构 | 用法 | 例句 |
|------|------|------|
| S + have/has + yet to do | 表示"尚未做某事" | I have yet to finish my homework.（我还没写完作业。） |
| S + be + yet to be done | 被动形式 | The research has yet to be completed.（这项研究还未完成。） |
...
**跨节联动：** have yet to do 可与 **It seems/appears that** 结合，如：It appears the project has yet to be finished.（看来这个项目尚未完成。）
...
| 结构 | 用法 | 例句 |
|------|------|------|
| S + have not + done + yet | 表示"还没做某事" | I have not finished my homework yet.（我还没有完成我的作业。） |
...
| 结构 | 用法 | 例句 |
|------|------|------|
| Have + S + done + yet? | 询问是否已完成 | Have you eaten yet?（你已经吃过饭了吗？） |
...
**跨节联动：** 疑问句中的 yet 可与 **already** 对比学习：Have you eaten yet?（还没吃吧？）vs Have you already eaten?（你已经吃了？）

---

## 从句：It seems / appears that 结构
...
| 结构 | 用法 | 例句 |
|------|------|------|
| It seems that + 从句 | 表示主观印象 | It seems that he is tired.（他似乎累了。） |
| It appears that + 从句 | 基于客观迹象判断 | It appears that the economy is recovering slowly.（经济似乎正在缓慢复苏。） |
...
| 原句 | 转换后 |
|------|--------|
| It appears that he has lost interest in the project. | He appears to have lost interest in the project. |

> [!warning] 注意完成式
> 如果从句动作发生在一个过去的时间，搬家后要用不定式的完成式 **to have done**，而不是 to do。

**跨节联动：** 主语转换结构可与 **might have done** 结合：He appears to have made a mistake.（= It appears that he might have made a mistake.）
...
| 写法 | 句型 | 例句 |
|------|------|------|
| 否定主句 | It does not seem/appear that + 从句 | It does not seem that he likes the plan. |
| 否定转移到从句 | It seems/appears that + 否定从句 | It seems that he doesn't like the plan. |

> [!tip] 语感差异
> 两种写法意思相同，但**否定转移到从句**（写法B）在口语中更自然；**否定主句**（写法A）在正式写作中更常见。

**跨节联动：** 否定结构可与 **yet** 结合：It appears that he has yet to decide.（看来他尚未决定。）
...
> [!tip] 解题技巧
> 1. **注意作者态度的转折**：文章先论述并购的好处（第3段），再用 Yet 转折强调仍需警惕（第5段），体现"先扬后抑"的论证结构
> 2. **形式主语 it 的识别**：文章多次出现 `it is hard to imagine that...`、`it does not appear that...`，需快速识别这是形式主语结构，真正主语在 that 从句中
> 3. **并列结构的省略**：如 `supervise, regulate and operate` 三个动词共享主语和助动词，阅读时需补全省略部分

> [!warning] 易错点
> 1. **hardly 的否定含义**：`hardly seem to bring` 不是"似乎带来"，而是"似乎不会带来"，hardly 是否定副词
> 2. **witness 的祈使句用法**：`—witness Daimler and Chrysler—` 不是"目击"，而是"试看、见证"，用于引出例证
> 3. **concerns over**：over 是介词，不是副词，意为"对……的担忧"

> [!question] 反思问题
> 1. 作者对并购浪潮的整体态度是什么？是完全支持还是有保留？
> 2. 文章中提到的 Standard Oil Trust 和 Microsoft 案例分别说明了什么？
> 3. 如何理解 `the same that underlie the globalization process` 中 the same 的指代？
...
**相关主题推荐：**
- [[2000-passage1-america-精读笔记]] — 美国经济相关话题
- 反垄断法律与经济学基础
- 全球化与跨国公司发展史

**后续文章建议：**
- 阅读更多经济类文章，积累 M&A、antitrust、monopoly 等高频词汇
- 关注《经济学人》《金融时报》等外刊中的企业并购报道

**补充学习资源：**
- 反垄断法基础知识（Sherman Act, Clayton Act）
- 金融术语：lender of last resort, megamergers, affiliates
...
- [A] M&A wave is purely beneficial to the global economy
- [B] M&A wave is dangerous and should be stopped
- [C] M&A wave brings both benefits and concerns that need monitoring
- [D] M&A wave is mainly driven by government policies

**2. 细节题**
According to the passage, which of the following is NOT mentioned as a driving force behind the M&A wave?
- [A] Falling transportation costs
- [B] Lower trade barriers
- [C] Government subsidies for mergers
- [D] Enlarged markets

**3. 推断题**
From the example of Standard Oil Trust, we can infer that __________.
- [A] all monopolies should be broken up
- [B] historical threats may not repeat in modern mergers
- [C] oil industry mergers are always harmful
- [D] the U.S. has strict anti-monopoly laws

**4. 态度题**
The author's attitude toward the M&A wave can be described as __________.
- [A] completely supportive
- [B] strongly opposed
- [C] cautiously optimistic with reservations
- [D] indifferent

**5. 词义题**
The word "scanty" (Paragraph 4) is closest in meaning to __________.
- [A] abundant
- [B] insufficient
- [C] controversial
- [D] reliable
...
- [[intermediate/2001-passage4-merger/formatted-article.md|格式化原文]]
- [[intermediate/2001-passage4-merger/translation.md|翻译对照]]
- [[intermediate/2001-passage4-merger/grammar-notes.md|语法笔记]]
