---
title: "Text 2 — Global Warming and the Smoking Analogy 精读笔记"
type: study-note
topic: "2005-passage2-global-warming"
tags:
  - english-reading
  - intensive-reading
  - study-note
...
# Global Warming and the Smoking Analogy 精读笔记

## 背景

本文选自 **2005 年全国硕士研究生入学统一考试英语（一）试题** Text 2，主题为**全球变暖**与**吸烟争议**的类比论证。文章通过回顾历史上烟草行业与科学界的争议，类比当下全球变暖问题中的科学不确定性与政策拖延，呼吁采取预防性措施。

> [!abstract] 文章概要
> 文章采用"历史类比 → 现状对比 → 批评分析 → 政策建议"的论述结构，属于**类比论证型**议论文。作者将吸烟争议中"怀疑论者拖延行动导致灾难"的教训，映射到全球变暖议题上。

- **难度**：intermediate
- **体裁**：议论文 (argumentation)
- **题源**：2005 年考研英语（一）真题
- **核心论证手法**：类比 (analogy)、反问 (rhetorical question)、头韵 (paralysis by analysis)
...
> | 成分 | 内容 |
> |------|------|
> | 主句（There be 句型） | There are upsetting parallels today |
> | 状语从句 | as scientists ... try to awaken us to ... |
>
> ### 2. 修饰成分
>
> | 修饰类型 | 内容 | 说明 |
> |----------|------|------|
> | 伴随状语从句（as） | as scientists in one wave after another try to awaken us to the growing threat of global warming | 表示"随着……"或"正如……" |
> | 介词短语作定语 | in one wave after another | 修饰 scientists，表示"一轮又一轮的" |
> | 介词短语作定语 | of global warming | 修饰 threat |
>
> ### 3. 结构图解
>
> ```text
> [主句] There are upsetting parallels today,
>   └── [伴随状语] as scientists in one wave after another
>         try to awaken us to the growing threat of global warming
> ```
>
> ### 4. 参考译文
> 如今出现了令人不安的相似情况，随着科学家们一轮又一轮地试图唤醒我们正视全球变暖这一日益严重的威胁。
>
> ### 5. 考点提示
...
> | 成分 | 内容 |
> |------|------|
> | 并列分句 1 | science does provide us with the best available guide to the future |
> | 并列分句 2（主句） | it is critical |
> | 主语从句（真正主语） | that our nation and the world base important policies on the best judgments |
> | 定语从句 | that science can provide concerning the future consequences of present actions |
>
> ### 2. 修饰成分
>
> | 修饰类型 | 内容 | 说明 |
> |----------|------|------|
> | 主语从句（形式主语 it） | that our nation and the world base important policies on the best judgments | 真正主语，谓语 base 为虚拟语气原形 |
> | 定语从句 | that science can provide | 修饰 the best judgments |
> | 现在分词短语作后置定语 | concerning the future consequences of present actions | 修饰 the best judgments |
>
> ### 3. 结构图解
>
> ```text
> [并列分句 1] science does provide us with the best available guide to the future,
>   and
> [并列分句 2] it is critical
>   └── [主语从句] that our nation and the world base important policies
>         on the best judgments
>         └── [定语从句] (that) science can provide
>         └── [后置定语] concerning the future consequences of present actions
> ```
>
> ### 4. 参考译文
> 但是科学确实为我们提供了面向未来的最佳现有指南，而关键是我们的国家和世界应当基于科学所能提供的、关于当前行为对未来后果的最佳判断来制定重要政策。
>
> ### 5. 考点提示
> - **虚拟语气**：在 critical 后的 that 从句中，base 使用原形（而非 bases），为 should + 动词原形的虚拟语气（should 已省略）
> - **形式主语 it**：it is critical that... 是考研高频句式，真正主语是 that 从句
> - **并列结构**：and 连接两个并列分句，逻辑上形成递进
...
> | 修饰类型 | 内容 | 说明 |
> |----------|------|------|
> | 独立主格结构（with + 名词 + 形容词） | With the risks obvious and growing | 表示伴随的原因或条件 |
> | 时间副词 | now | 作状语 |
>
> ### 3. 结构图解
>
> ```text
> [独立主格] With the risks obvious and growing,
>   └── [主句] a prudent people would take out an insurance policy now.
>         ├── 主语：a prudent people
>         ├── 谓语：would take out
>         └── 宾语：an insurance policy
> ```
>
> ### 4. 参考译文
> 随着风险日益明显且不断加剧，一个谨慎的民族现在就应该买一份保险了。
>
> ### 5. 考点提示
> - **with 独立主格结构**：with + 名词 + 形容词，表示伴随原因，是考研翻译高频考点
> - **would 的情态动词用法**：此处 would 表"应该做……"，而非单纯过去将来时
> - **a prudent people 中 people 的可数用法**：people 在此指"民族/国家"（可数名词），而非"人们"
> - **insurance policy 的比喻义**：并非真正保险单，喻指预防性措施（环保立法）
...
> | 主语 | A bill |
> | 系动词 | is |
> | 表语 | a promising start |
>
> ### 2. 修饰成分
>
> | 修饰类型 | 内容 | 说明 |
> |----------|------|------|
> | 介词短语作后置定语 | by Democratic Senator Robert Byrd of West Virginia | 说明提案提出者 |
> | 非限制性定语从句 | which would offer financial incentives for private industry | 补充说明提案内容 |
>
> ### 3. 结构图解
>
> ```text
> 主语：A bill
>   ├── [后置定语] by Democratic Senator Robert Byrd of West Virginia,
>   └── [非限制性定语从句] which would offer financial incentives
...
>
> ### 4. 参考译文
> 西弗吉尼亚州民主党参议员罗伯特·伯德提出的一项法案——该法案将为私营企业提供财政激励——是一个有希望的开端。
>
> ### 5. 考点提示
...
> | 成分 | 内容 |
> |------|------|
> | 主句（形式主语 it） | it is crucial |
> | 主语从句（真正主语） | that those new plants be environmentally sound |
> | 条件状语从句 | If we are ever going to protect the atmosphere |
>
> ### 2. 修饰成分
>
> | 修饰类型 | 内容 | 说明 |
> |----------|------|------|
> | 条件状语从句 | If we are ever going to protect the atmosphere | 表示前提条件 |
> | 主语从句（虚拟语气） | that those new plants be environmentally sound | 真正主语，谓语用原形 be |
>
> ### 3. 结构图解
>
> ```text
> [条件状语] If we are ever going to protect the atmosphere,
> [主句] it is crucial
>   └── [主语从句] that those new plants be environmentally sound
>         ├── 主语：those new plants
>         ├── 系动词：be（虚拟语气原形）
>         └── 表语：environmentally sound
> ```
>
> ### 4. 参考译文
> 如果我们真的要保护大气层，那么这些新电厂必须对环境无害，这一点至关重要。
>
> ### 5. 考点提示
> - **be 型虚拟语气**：在 crucial, important, necessary 等形容词后的 that 从句中，谓语动词用 (should +) 动词原形，此处 be 为省略 should 的虚拟语气
...
还记得那些年科学家认为抽烟会致人死亡，但是怀疑者却争辩说这件事还没有定论；争辩说证据还不确凿，科学也不确定；争辩说那些反对抽烟的游说只会毁掉我们的生活方式，所以政府应该不要干涉的时候吗？很多美国人相信了这些胡言乱语，30年来，大约有一千万烟民过早离开了人世。

> [!note] 排比问句翻译
> 原文连续三个 "That..." 引导的排比问句，中文用分号连接保持排比结构。"bought that nonsense"译为"相信了这些胡言乱语"，保留原文的反讽语气。
...
科学家们一波接着一波试图让我们意识到全球气候变暖带来的不断加剧的威胁，此时又出现了令人担忧的类似事情。最近的一次行动是由白宫召集了一个来自国家科学院的专家小组，他们告诉我们，全球气候毫无疑问正在变暖，而且这个问题主要是人为造成的。这条明确的信息就是我们应该着手保护自己。国家科学院院长布鲁斯·艾伯特在专家小组报告的前言中加了一个重要观点："科学不可能解决所有问题。但是科学确实为我们的未来提供了最好的指导，关键是我们的国家和世界各国在做重要决策时，应该依据科学能够提供给我们的对于人类现在的行为对未来影响的最好判断。"

> [!note] 长句拆分
> "the best judgments that science can provide concerning the future consequences of present actions" 译为"科学能够提供给我们的对于人类现在的行为对未来影响的最好判断"，需要调整语序使中文通顺。

---

Just as on smoking, voices now come from many quarters insisting that the science about global warming is incomplete, that it's OK to keep pouring fumes into the air until we know for sure. This is a ==dangerous game==: by the time 100 percent of the evidence is in, it may be too late. With the risks obvious and growing, a prudent people would take out an insurance policy now.

像抽烟问题一样，来自不同领域的声音坚持认为：有关全球变暖的科学资料还不完善，因此在我们确定这件事之前可以继续向大气中排放气体。但这是一场危险的游戏：当百分之百的证据出现时，也许就太迟了。如今危险明显存在，而且在不断加剧，一个谨慎的民族应该准备一份保单了。

> [!note] 比喻修辞
> "take out an insurance policy"直译为"购买一份保险"，这里引申为"采取预防措施"，中文译为"准备一份保单"保留比喻。

---

Fortunately, the White House is starting to pay attention. But it's obvious that a majority of the president's advisers still don't take global warming seriously. Instead of a plan of action, they continue to press for more research — a classic case of **"paralysis by analysis."**

幸运的是，白宫正在开始关注这件事。但是显然总统身边的大多数顾问都没有认真对待全球变暖的问题。他们还在不断要求进行更多的研究，而不是去出台行动计划——一个典型的"过度分析，导致麻痹"的实例。

> [!note] "paralysis by analysis"
> 英语中的头韵修辞（paralysis / analysis），中文译为"过度分析，导致麻痹"，以对仗形式传达原文的双关意味。
...
- a small village **out of the way** → 一个偏僻的小村庄
...
- **以某人自己的方式**
  - Everyone learns **in his own way**. → 每个人都有自己的学习方式。

**in a way**
- **在某种程度上；从某种意义上说**（考研阅读常见表达）
  - **In a way**, he is right. → 从某种意义上说，他是对的。
...
- Winter is **on its way**. → 冬天快来了。（即将发生）

---

#### ⑥ by the way

**基本含义：** 顺便说一下；对了（用于引出补充信息）
...
| 短语 | 含义 | 例句 |
|------|------|------|
| **in the way** | = 挡住了 | The car is **in the way**.（车挡路。） |
| **out of the way** | = 移开了，不挡了 | Move the car **out of the way**.（把车移走。） |

##### ② in a way ≠ in one's way

| 短语 | 含义 | 例句 |
|------|------|------|
| **in a way** | = 某种程度上 | **In a way**, this is true.（某种程度上，这是真的。） |
| **in one's way** | = 挡某人的路 / 按某人的方式 | Don't get **in my way**.（不要妨碍我。） |

##### ③ get in the way of（高频）

固定搭配：`get in the way of + 名词 / doing` = 阻碍……
...
**含义：** 把 A 建立在 B 的基础上；以 B 为依据形成 A

**也可理解为：** `A is based on B` — A 以 B 为基础

#### 例句（考研常见）

**主动：**
- The theory **is based on** scientific research. → 这个理论建立在科学研究的基础上。
- We should **base our decisions on** facts. → 我们应该以事实为依据做决定。

**被动（考研阅读高频）：** `be based on` = 建立在……基础上；以……为依据
- The report **is based on** recent studies. → 这份报告基于最近的研究。
...
**例：**
- a **sound** argument → 一个可靠、有说服力的论点
- a **reasonable** explanation → 一个合理的解释
...
> [!tip] 阅读技巧：类比论证识别
> 本文核心论证手法是**类比（analogy）**——将吸烟争议中"怀疑论者以科学不确定性为借口拖延行动"的模式，映射到全球变暖议题。考研阅读中类比题的常见考点是"作者为什么引用 X 事例来说明 Y？"（如第 30 题），正确答案往往是"从 X 中获得的教训适用于 Y"。

> [!tip] 修辞手法识别
> **paralysis by analysis** 是头韵（alliteration）修辞，考研阅读中遇到带引号的自创短语，往往是词义理解题（如第 28 题）的考查对象。解题关键是结合上下文推断：前文说"press for more research instead of action"，因此该短语意为"过度分析扼杀行动"。

> [!warning] 易错点
> - **熟词生义**：`bought` 本文中意为"相信"而非"购买"；`plants` 文中意为"发电厂"而非"植物"
> - **虚拟语气**：`it is critical that... base...` 中 base 为原形虚拟，不可误判为语法错误
> - **people 可数**：`a prudent people` 中 people 指"民族/国家"而非"人们"

> [!question] 反思
> 1. 作者为什么以反问句开篇？这种修辞对读者有何心理影响？
> 2. 文章中 "insurance policy" 是一个比喻，它究竟指代什么具体措施？
> 3. 你对 "paralysis by analysis" 这一现象有什么自己的生活经验可以关联？
...
- 环境政策与科学不确定性
- 公共健康 vs 个人自由（吸烟禁令的伦理辩论）
- 预防原则（Precautionary Principle）
- 科学传播与公众认知

### 推荐后续阅读

- [[2003-passage1-science-censorship]] — 科学与社会议题
- [[考研英语类比论证阅读技巧]] — 类比论证专题
- [[2005-passage1-fair-play]] — 同年度其他真题

### 补充资源

- 考研英语《阅读的逻辑》—— 论证方法章节
- The Economist 环境板块文章
- IPCC（政府间气候变化专门委员会）报告简介
...
26. **An argument made by supporters of smoking was that**
   ...
   > **思路**：第一段三个 "That..." 排比问句列出了吸烟支持者的论点。第三个 That 从句提到 "the antismoking lobby was out to destroy our way of life"，对应 C 选项"选择自己生活方式的自由"。
...
27. **According to Bruce Alberts, science can serve as**
   ...
   > **思路**：原文直接引用 Bruce Alberts 的话："science does provide us with the **best available guide** to the future"，guide 是原文关键词。
...
28. **What does the author mean by "paralysis by analysis" (Last line, Paragraph 4)?**
   ...
   > **思路**：前文说 "Instead of a plan of action, they continue to press for more research"，说明"只研究不行动"，因此 A 正确。
...
29. **According to the author, what should the Administration do about global warming?**
   ...
   > **思路**：文中明确说 "If the Administration won't take the **legislative initiative**, Congress should help...", 正确选项 D 与 legislative initiative 对应。
...
30. **The author associates the issue of global warming with that of smoking because**
   ...
   > **思路**：全文核心结构是类比——吸烟争议的教训（怀疑论者以不确定性拖延行动导致灾难）同样适用于全球变暖。B 正确。
