---
title: "Lesser Prairie Chicken Conservation 精读笔记"
type: study-note
...
sources:
  - "2016 考研英语一 Text 2"
  - "intermediate/2016-passage2-prairie-chicken/formatted-article.md"
  - "intermediate/2016-passage2-prairie-chicken/translation.md"
  - "intermediate/2016-passage2-prairie-chicken/grammar-notes.md"
  - "intermediate/2016-passage2-prairie-chicken/固定搭配与词组笔记.md"
---
...
```mermaid
graph TD
    A[P1 数据铺陈：曾多达 200 万只 → 如今仅约 22000 只，只占历史分布范围的约 16%——危机以数量断崖呈现] --> B[P2 决策交代：The crash was a major reason，USFWS 正式列为 threatened；环保人士失望（他们要 endangered，因为那带来 greater regulatory power），Ashe 一方主张 threatened 给了 flexibility，可与西部各州和掌控 95% 栖息地的私人土地所有者合作]
    B --> C[P3 机制拆解：签署覆盖全范围的管理计划者可免于起诉；破坏栖息地者向基金缴款，每破坏 1 英亩补 2 英亩；基金补偿留出栖息地的土地所有者；中期目标年均 67000 只；监测职责交给 WAFWA——总体思路是让各州 remain in the driver's seat]
    C --> D[P4 争议对照：Not everyone buys the win-win rhetoric——国会议员阻挠、行业团体与四州及三个环保组织在联邦法院起诉；行业与州嫌 goes too far，环保组织嫌 doesn't go far enough；Lininger 批评责任被交给正把鸟推向灭绝的行业]
```
