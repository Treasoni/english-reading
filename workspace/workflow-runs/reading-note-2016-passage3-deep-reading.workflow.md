...
run_id: "reading-note-2016-passage3-deep-reading"
task: "生成 2016-passage3-deep-reading 综合精读笔记并放入 2016阅读"
...
mode: guided
blocked_reason: ""
article_source: "/Users/zhqznc/Documents/英语阅读资料/2016阅读/passage_3.md"
year: "2016"
passage: "3"
topic: "deep-reading"
intermediate_dir: "intermediate/2016-passage3-deep-reading/"
output_path: "2016阅读/2016-passage3-deep-reading-精读笔记.md"
long_sentence_mode: "AI 候选 + 用户确认"
grammar_source: "从本文提取考研相关语法点（用户未提供现成语法笔记）"
---
...
- **中间目录**：`intermediate/2016-passage3-deep-reading/`
- **最终笔记**：`2016阅读/2016-passage3-deep-reading-精读笔记.md`
- **全局汇总**：`语法总结笔记.md`（63 篇源，差集为空）、`固定搭配与词组笔记.md`（70 条 processed，差集为空）
- **完成状态**：P0–P9 全部完成
