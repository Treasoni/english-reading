...
- Change batch phase state only with `.claude/scripts/todo-state.sh`.
- Run `.claude/scripts/todo-state.sh <state-file> validate` before reporting batch completion.
...
6. Start P0 with `.claude/scripts/todo-state.sh <state-file> start P0`.
